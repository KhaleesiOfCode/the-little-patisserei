      ...
      <section className="mx-auto flex max-w-lg flex-col items-center px-4 py-10 md:py-14">
        ...
        >
          ...
          >
            ...
            {/* Delivery tracking */}
            {mode === "local_delivery" && (
              <div className="mt-4 rounded-xl bg-blue-50 p-4 text-center ring-1 ring-blue-200">
            ...
            {/* Courier tracking */}
            {mode === "courier" && (
              <div className="mt-4 rounded-xl bg-indigo-50 p-4 text-center ring-1 ring-indigo-200">
